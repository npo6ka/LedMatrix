...
#define LEDS_WIDTH              (1)                        // ширина матрицы
#define LEDS_HEIGHT             (300)                        // высота матрицы
#define LEDS_MAX_POWER          (5000U)                      // лимит по току в миллиамперах, автоматически управляет яркостью (пожалей свой блок питания!) 0 - выключить лимит
#define LEDS_BRIGHTNRSS         (255)                        // яркость матрицы 0 - 255
